...
final List<CategoryModel> categories = [
  CategoryModel(icon: Icons.terrain, category: 'Mountain'),
  CategoryModel(icon: Icons.park, category: 'Forest'),
  CategoryModel(icon: Icons.beach_access, category: 'Beach'),
  CategoryModel(icon: Icons.directions_walk, category: 'Hiking'),
];
...
class AppBottomBarItem {
  ...
  bool isSelected;
  String label;
  AppBottomBarItem({required this.icon, required this.isSelected,   this.label = 'false'});
}
